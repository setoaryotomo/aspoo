                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <vue-multiselect v-model="barang_scm.id_barang_master" :searchable="true" :options="barang_list" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            watch: {
                "barang_scm.id_barang_master": {
                    handler: function(value) {
                        ...
                        this.barang_scm.id_barang_master = value
