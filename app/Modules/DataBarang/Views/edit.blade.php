...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" style="margin-bottom: 6px">
                                ...
                                <input v-model="barang.nama_barang" class="form-control" type="text" required>
                            </div>
    ...
    // Make sure the multiselect values are properly set
    // Only set these if they exist in the options arrays
    if (response.data.result.kategori_umum) {
        this.barang.kategori_umum = response.data.result.kategori_umum
    }
    if (response.data.result.kategori_nama) {
        this.barang.kategori_nama = response.data.result.kategori_nama
    }
    if (response.data.result.kategori_produk) {
        this.barang.kategori_produk = response.data.result.kategori_produk
    }
    if (response.data.result.rasa) {
        this.barang.rasa = response.data.result.rasa
    }
    if (response.data.result.jenis_kemasan) {
        this.barang.jenis_kemasan = response.data.result.jenis_kemasan
    }
    if (response.data.result.bahan_dasar) {
        this.barang.bahan_dasar = response.data.result.bahan_dasar
    }
    if (response.data.result.kekhasan) {
        this.barang.kekhasan = response.data.result.kekhasan
    }
    if (response.data.result.basah_kering) {
        this.barang.basah_kering = response.data.result.basah_kering
    }
