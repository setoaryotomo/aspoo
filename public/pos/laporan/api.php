...
switch ($req) {
    case "ambilData":
        ...
        // Cari Penjualan
        $return['penjualan'] = getData("SELECT * FROM penjualan_child INNER JOIN barang ON penjualan_child.`penjualan_child_obat_id` = barang.`id` WHERE penjualan_child_dibuat BETWEEN '$hari1' AND '$hari2' ORDER BY barang.`id`");
        $arr = [];
